<template>
  <div class="flex h-screen bg-gray-50">
    ...
    >
      <!-- Sidebar Header -->
      <div class="p-6 pr-0 border-b border-gray-100">
        <div
          :class="
            !isCollapsed
        ...
        >
          <router-link to="/" class="flex items-center space-x-3">
            <div
              class="w-10 h-10 bg-coral-500 rounded-xl flex items-center justify-center"
            >
              <span class="text-white font-bold text-lg">E</span>
            </div>
            <span v-if="!isCollapsed" class="text-xl font-bold text-gray-900"
              >Lnaid</span
            >
          </router-link>
          <button
      ...
      <!-- User Profile -->
      <div :class="!isCollapsed ? 'p-6 border-b border-gray-100' : 'p-5 pr-1'">
        ...
        <div v-for="item in navigationItems" :key="item.name">
          ...
          >
            ...
            <div v-if="item.badge && !isCollapsed" class="ml-auto">
              <span
                class="bg-coral-500 text-white text-xs px-2 py-1 rounded-full"
                >{{ item.badge }}</span
              >
            </div>
          </router-link>
          ...
          <div v-else>
            ...
            >
              ...
              <span
                v-if="!isCollapsed"
                class="ml-3 font-medium flex-1 text-left"
                >{{ item.name }}</span
              >
              <svg
                v-if="!isCollapsed"
      ...
      <header class="bg-white shadow-sm border-b border-gray-100 px-6 py-4">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p v-if="pageSubtitle" class="text-gray-600 mt-1">
              {{ pageSubtitle }}
            </p>
          </div>
...
// Use navigation items from props instead of hardcoding them
